            ...
            <div className="container mx-auto max-w-5x">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 font-semibold">
                        ...
                        <a href="../public/Resume_aug_22_developer.pdf" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300 shadow-[0_0_20px_rgba(139,92,246,0.5)]">
                            {" "}
                            Download My Resume
                        </a>
